...
class ProductProduct (models.Model):
    ...
    discharge_date = fields.Char(string="Fecha de Alta", compute="_compute_discharge_date")
    first_entry_date = fields.Char(string="Fecha de Primer Ingreso", compute="_compute_date_first_entry")
    first_sale_date = fields.Char(string="Fecha de Primera Venta", compute="_compute_date_firts_sale")
    last_entry_date = fields.Char(string="Fecha de Último Ingreso", compute="_compute_date_last_entry")
    last_sale_date = fields.Char(string="Fecha de Última Venta", compute="_compute_date_last_sale")
